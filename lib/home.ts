...
export const aboutItems: AboutItem[] = [
  ...
  {
    html: `After high school, I took a gap year from Stanford to work at <a class="notion-link" href="https://palantir.com/" target="_blank" rel="noopener noreferrer">Palantir</a> in New York.<br class="sm:hidden" /> I grew up in Pittsburgh and live in SF today.`,
  },
  {
