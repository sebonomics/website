...
export const writingPosts: WritingPost[] = [
  {
    ...
    blocks: [
      ...
      "It becomes obvious that the way you make a lot of money or create a lot of impact is to find places where 99% people are mistaken and you are right.",
      ...
      "Instead, we are building:",
      {
        items: [
          ...
          "A 6th hiring platform for startups",
